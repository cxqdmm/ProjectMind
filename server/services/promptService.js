...
export function readAgentsPrompt() {
  ...
  const usage = [
    ...
    '- 批量调用：CALL_JSONS: [{\\"provider\\":\\"openskills\\",\\"tool\\":\\"read\\",\\"input\\":{\\"skill\\":\\"<skill-name>\\"}},{\\"provider\\":\\"openskills\\",\\"tool\\":\\"call\\",\\"input\\":{\\"skill\\":\\"<skill-name>\\",\\"script\\":\\"scripts/<script-file>\\",\\"param\\":{\\"<param1>\\":\\"<value1>\\",...}}}]',
    '',
    '必须遵守的规范：',
